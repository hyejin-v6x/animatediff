...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    @classmethod
    def from_pretrained_2d(cls, pretrained_model_name_or_path, unet_config=None, unet_additional_kwargs={}, **kwargs):
        print('cls', cls)
        from diffusers import __version__
        from diffusers.utils import HF_MODULES_CACHE, SAFETENSORS_WEIGHTS_NAME, WEIGHTS_NAME, is_safetensors_available
        from diffusers.models.modeling_utils import load_state_dict
        print(f"loaded 3D unet's pretrained weights from {pretrained_model_name_or_path} ...")

        cache_dir = kwargs.pop("cache_dir", HF_MODULES_CACHE)
